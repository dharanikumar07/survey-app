...
GRAPHQL;
    ...
    public function getParentProductByPlatformId($platformProductId)
    {
        $product = Products::where(['platform_product_id' => $platformProductId])->first();
    ...
    public function getVariantProductByPlatformId($platformVariantId)
    {
        $product = Products::where(['platform_variation_id' => $platformVariantId])->first();
