(() => {
  ...
  // extensions/post-purchase-survey/src/Checkout.js
  var Checkout_default = extension("purchase.thank-you.block.render", (root, api) => {
    root.replaceChildren(
      root.createComponent(
        Banner,
        { title: "The survey from the app will be shown here." }
      )
    );
  });
  ...
  // extensions/post-purchase-survey/src/OrderStatus.js
  var OrderStatus_default = extension2("customer-account.order-status.block.render", (root, api) => {
    root.replaceChildren(
